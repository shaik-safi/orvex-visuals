...
function ServicesHero({ messages }: { messages: ServicesPageMessages }) {
  return (
    <section className="pt-28 pb-12 sm:pt-32 md:pt-40 md:pb-16 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 relative overflow-hidden">
      <div className="absolute top-12 left-1/2 h-[min(72vw,37.5rem)] w-[min(72vw,37.5rem)] -translate-x-1/2 bg-amber-500/5 rounded-full blur-3xl pointer-events-none sm:left-1/4 sm:translate-x-0" />
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 bg-amber-50 dark:bg-amber-500/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform duration-200">

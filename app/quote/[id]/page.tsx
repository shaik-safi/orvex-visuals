...
export default function QuotePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen pt-28 pb-16 print:pt-0 print:bg-white">
      <div className="max-w-3xl mx-auto px-4 mb-6 flex items-center justify-between print:hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 print:px-0">
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow print:shadow-none print:border-0 overflow-hidden">
          <div className="bg-slate-900 text-white px-8 py-8 print:bg-white print:text-slate-900 print:px-0 print:pb-4 print:border-b print:border-slate-300">

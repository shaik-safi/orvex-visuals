      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            ...
            <p>When you use our booking form, contact form, or WhatsApp, we may collect your name, phone number, email address (optional), event details (date, venue, type), and budget preferences. We do not collect payment card information. Payments, if applicable, are handled separately via UPI or bank transfer.</p>

            <h2 className="text-xl font-bold text-slate-900 dark:text-white mt-8">2. How We Use Your Information</h2>
            <p>We use your information to respond to your inquiry, prepare estimates or booking summaries, coordinate your photography session, and continue the conversation over WhatsApp, email, or phone when needed. We never sell or rent your personal data for third-party marketing.</p>
            ...
            <p>Inquiry and booking details submitted through the site may be stored in secured systems that are accessible only to authorized team members. Some conversations may continue on WhatsApp or email after submission. Media retention and archival timelines can vary by project and are confirmed directly with the client instead of being guaranteed globally on the site.</p>
            ...
            <p>We use services such as WhatsApp Business (Meta) for communication, Firebase/Firestore for inquiry and booking storage, Google Drive or similar delivery tools for media handoff, and Vercel for hosting. Each service has its own privacy policy governing its handling of data.</p>

            <h2 className="text-xl font-bold text-slate-900 dark:text-white mt-8">7. Your Rights</h2>
            <p>You may request: access to your stored data, correction of inaccurate data, deletion of your data, or withdrawal of portfolio consent at any time. Contact us at {EMAIL} for any privacy-related requests.</p>

            <h2 className="text-xl font-bold text-slate-900 dark:text-white mt-8">8. Contact</h2>
            <p>For privacy concerns, email us at <strong>{EMAIL}</strong> or message us on WhatsApp at {PHONE_DISPLAY}.</p>
          </div>
        </div>
      </section>
    </main>

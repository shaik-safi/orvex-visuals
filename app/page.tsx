...
const features = [
  ...
  { icon: Smartphone, title: "Start Online", desc: `Build an estimate online, then move to booking when you're ready. We'll guide you from there, usually ${RESPONSE_TIME_PROMISE}.`, stat: RESPONSE_TIME_PROMISE },
]

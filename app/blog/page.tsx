...
function BlogHero({ messages }: { messages: BlogMessages }) {
  ...
  return (
    <section className="pt-28 pb-10 sm:pt-32 md:pt-40 md:pb-14 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 relative overflow-hidden">
      <div className="absolute top-12 left-1/2 h-[min(72vw,31.25rem)] w-[min(72vw,31.25rem)] -translate-x-1/2 bg-amber-500/5 rounded-full blur-3xl pointer-events-none sm:left-1/4 sm:translate-x-0" />
